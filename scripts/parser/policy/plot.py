...
for i in range(0,num_config):
    temp_list = []
    temp_list.append(math.log(latt_score[i],2))
    temp_list.append(math.log(sevenzip_score[i],2))
    temp_list.append(math.log(ff_score[i],2))
    temp_list.append(math.log(hackbench_score[i],2))
    temp_list.append(math.log(jtr_score[i],2))
    temp_list.append(math.log(hackbench_score[i+14],2))
    temp_list.append(math.log(hackbench_score[i+21],2))
    temp_list.append(math.log(hackbench_score[i+7],2))
    temp_list.append(math.log(jtr_score[i+7],2))
    temp_list.append(math.log(jtr_score[i+14],2))
